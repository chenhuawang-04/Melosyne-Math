/**
 * @brief Isolated mat4Translation benchmark
 * Purpose: Test different Translation implementations without affecting other functions
 */
...
int main() {
    ...
    cout << "\n";
    cout << "================================================================\n";
    cout << "  mat4Translation Isolated Benchmark\n";
    cout << "================================================================\n";
    ...
    double time = benchmark_median([&]() {
        for (int iter = 0; iter < ITERS; ++iter)
            for (int i = 0; i < COUNT; ++i)
                results[i] = MMath::mat4Translation(1.0f, 2.0f, 3.0f);
        sink = results[0].m[0];
    });

    cout << "  mat4Translation: " << fixed << setprecision(2) << time << " ms\n";
    cout << "  Performance: " << setprecision(1) << (TOTAL_OPS / time / 1000.0) << " M ops/s\n";
    cout << "\n";
    cout << "  Target: < 1.25 ms (Eigen performance)\n";
