 ...
 * @param a First bitset
 * @param b Second bitset
 * @return |A ∪ B| = number of bits set in (a OR b)
 *
 * Algorithm:
 ...
 * @param a First bitset
 * @param b Second bitset
 * @return |A ∩ B| = number of bits set in (a AND b)
 *
 * Use cases:
...
/**
 * @brief Jaccard similarity coefficient: |A ∩ B| / |A ∪ B|
 * @param a First bitset
 * @param b Second bitset
...
/**
 * @brief Dice coefficient (Sørensen-Dice): 2 * |A ∩ B| / (|A| + |B|)
 * @param a First bitset
 * @param b Second bitset
...
/**
 * @brief Test if A is a subset of B (A ⊆ B) - scalar version
...
/**
 * @brief Test if A and B have any common set bits (A ∩ B ≠ ∅) - scalar version
 * @param a First bitset
 * @param b Second bitset
