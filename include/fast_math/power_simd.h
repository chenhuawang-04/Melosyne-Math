...
#if defined(__AVX2__)
    static const __m256 kLn2_256 = _mm256_set1_ps(0.693147180559945309417232121458176568f);
    static const __m256 kLog2E_256 = _mm256_set1_ps(1.44269504088896340735992468100189214f);
    static const __m256 kLn10_256 = _mm256_set1_ps(2.30258509299404568401799145468436421f);
    static const __m256 kLog10E_256 = _mm256_set1_ps(0.434294481903251827651128918916605082f);

    static const __m256 kExpMaxInput_256 = _mm256_set1_ps(88.376f);
    static const __m256 kExpMinInput_256 = _mm256_set1_ps(-87.336f);

    static const __m256 kOne_256 = _mm256_set1_ps(1.0f);
    static const __m256 kHalf_256 = _mm256_set1_ps(0.5f);
    static const __m256 kZero_256 = _mm256_setzero_ps();

    // exp polynomial coefficients
    static const __m256 kExpC1_256 = _mm256_set1_ps(1.0f);
    static const __m256 kExpC2_256 = _mm256_set1_ps(0.5f);
    static const __m256 kExpC3_256 = _mm256_set1_ps(0.166666666666666851703837234430154323f);
    static const __m256 kExpC4_256 = _mm256_set1_ps(0.0416666666666665970564002484798622411f);
    static const __m256 kExpC5_256 = _mm256_set1_ps(0.00833333333333328885369231554654299327f);

    // log polynomial coefficients
    static const __m256 kLogP0_256 = _mm256_set1_ps(7.0376836292E-2f);
    static const __m256 kLogP1_256 = _mm256_set1_ps(-1.1514610310E-1f);
    static const __m256 kLogP2_256 = _mm256_set1_ps(1.1676998740E-1f);
    static const __m256 kLogP3_256 = _mm256_set1_ps(-1.2420140846E-1f);
    static const __m256 kLogP4_256 = _mm256_set1_ps(1.4249322787E-1f);
    static const __m256 kLogP5_256 = _mm256_set1_ps(-1.6668057665E-1f);
    static const __m256 kLogP6_256 = _mm256_set1_ps(2.0000714765E-1f);
    static const __m256 kLogP7_256 = _mm256_set1_ps(-2.4999993993E-1f);
    static const __m256 kLogP8_256 = _mm256_set1_ps(3.3333331174E-1f);

    static const __m256 kSqrt2Over2_256 = _mm256_set1_ps(0.707106781186547524400844362104849039f);

    static const __m256i kExpBias_256i = _mm256_set1_epi32(127);
    static const __m256i k23_256i = _mm256_set1_epi32(23);
    static const __m256i k0x7FFFFF_256i = _mm256_set1_epi32(0x007FFFFF);
    static const __m256i k0x3F800000_256i = _mm256_set1_epi32(0x3F800000);
    static const __m256i k0xFF_256i = _mm256_set1_epi32(0xFF);
#endif

#if defined(__SSE4_1__)
    static const __m128 kLn2_128 = _mm_set1_ps(0.693147180559945309417232121458176568f);
    static const __m128 kLog2E_128 = _mm_set1_ps(1.44269504088896340735992468100189214f);
    static const __m128 kLn10_128 = _mm_set1_ps(2.30258509299404568401799145468436421f);
    static const __m128 kLog10E_128 = _mm_set1_ps(0.434294481903251827651128918916605082f);

    static const __m128 kExpMaxInput_128 = _mm_set1_ps(88.376f);
    static const __m128 kExpMinInput_128 = _mm_set1_ps(-87.336f);

    static const __m128 kOne_128 = _mm_set1_ps(1.0f);
    static const __m128 kHalf_128 = _mm_set1_ps(0.5f);
    static const __m128 kZero_128 = _mm_setzero_ps();

    // exp polynomial coefficients
    static const __m128 kExpC1_128 = _mm_set1_ps(1.0f);
    static const __m128 kExpC2_128 = _mm_set1_ps(0.5f);
    static const __m128 kExpC3_128 = _mm_set1_ps(0.166666666666666851703837234430154323f);
    static const __m128 kExpC4_128 = _mm_set1_ps(0.0416666666666665970564002484798622411f);
    static const __m128 kExpC5_128 = _mm_set1_ps(0.00833333333333328885369231554654299327f);

    // log polynomial coefficients
    static const __m128 kLogP0_128 = _mm_set1_ps(7.0376836292E-2f);
    static const __m128 kLogP1_128 = _mm_set1_ps(-1.1514610310E-1f);
    static const __m128 kLogP2_128 = _mm_set1_ps(1.1676998740E-1f);
    static const __m128 kLogP3_128 = _mm_set1_ps(-1.2420140846E-1f);
    static const __m128 kLogP4_128 = _mm_set1_ps(1.4249322787E-1f);
    static const __m128 kLogP5_128 = _mm_set1_ps(-1.6668057665E-1f);
    static const __m128 kLogP6_128 = _mm_set1_ps(2.0000714765E-1f);
    static const __m128 kLogP7_128 = _mm_set1_ps(-2.4999993993E-1f);
    static const __m128 kLogP8_128 = _mm_set1_ps(3.3333331174E-1f);

    static const __m128 kSqrt2Over2_128 = _mm_set1_ps(0.707106781186547524400844362104849039f);

    static const __m128i kExpBias_128i = _mm_set1_epi32(127);
    static const __m128i k23_128i = _mm_set1_epi32(23);
    static const __m128i k0x7FFFFF_128i = _mm_set1_epi32(0x007FFFFF);
    static const __m128i k0x3F800000_128i = _mm_set1_epi32(0x3F800000);
    static const __m128i k0xFF_128i = _mm_set1_epi32(0xFF);
#endif
