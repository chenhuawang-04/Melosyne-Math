...
#include "bitset_static.h"   // BitSet<N> - compile-time fixed size
#include "bitset_dynamic.h"  // DynamicBitSet - runtime size with PMR
#include "bitset_view.h"     // BitSetView, ConstBitSetView - unified view

// ============================================================================
// Scalar Operations (always available)
// ============================================================================

#include "bit_ops_core.h"     // AND, OR, XOR, NOT, ANDNOT, copy, equal
#include "bit_ops_count.h"    // popcount, hammingDistance, any/none/all, set ops
#include "bit_ops_scan.h"     // findFirst/Last/Next/Prev, select, rank, iterator
#include "bit_ops_range.h"    // setRange, resetRange, flipRange, testAll/Any/None
#include "bit_ops_advanced.h" // reverse, rotate, byteSwap, parity, PEXT/PDEP, etc.
...
#include "bit_ops_core_simd.h"     // AVX2 optimized AND/OR/XOR/NOT/ANDNOT
#include "bit_ops_count_simd.h"    // Harley-Seal popcount, fused operations
#include "bit_ops_scan_simd.h"     // Limited SIMD (select, rank only)
#include "bit_ops_range_simd.h"    // AVX2 bulk range operations
#include "bit_ops_advanced_simd.h" // Bulk reverse, byteSwap, rotate
