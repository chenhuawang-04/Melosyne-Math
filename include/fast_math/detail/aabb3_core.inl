// Shared Aabb3 implementation for header/module parity.
...
inline Aabb3 aabb3Transform(Aabb3 aabb_, Mat4 matrix_) noexcept {
    ...
    Vec4 corners[8] = {
        mat4MultiplyVec4(matrix_, {minx, miny, minz, 1.0f}),
        mat4MultiplyVec4(matrix_, {maxx, miny, minz, 1.0f}),
        mat4MultiplyVec4(matrix_, {minx, maxy, minz, 1.0f}),
        mat4MultiplyVec4(matrix_, {maxx, maxy, minz, 1.0f}),
        mat4MultiplyVec4(matrix_, {minx, miny, maxz, 1.0f}),
        mat4MultiplyVec4(matrix_, {maxx, miny, maxz, 1.0f}),
        mat4MultiplyVec4(matrix_, {minx, maxy, maxz, 1.0f}),
        mat4MultiplyVec4(matrix_, {maxx, maxy, maxz, 1.0f})
    };
