// Shared core POD type definitions for header/module parity.
 ...
 *       Mat4 is optimized for GPU upload and canonical RH helpers using
 *       zero-to-one clip-space depth (Direct3D/Vulkan/Metal style).
 *       Mat3 is optimized for CPU-side 2D calculations.
 */
...
/**
 * @brief Result wrapper for checked Mat3 inversion
 */
struct Mat3InverseResult {
    Mat3 value;
    bool invertible;
};

/**
 * @brief Result wrapper for checked Mat4 inversion
 */
struct Mat4InverseResult {
    Mat4 value;
    bool invertible;
};
